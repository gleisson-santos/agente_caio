...
- [[.test_empty_session_consolidation()]] - `calls` [EXTRACTED]
...
- [[.test_single_message_session()]] - `calls` [EXTRACTED]
...
- [[Extract messages that would be consolidated using the standard slice logic.]] - `rationale_for` [EXTRACTED]
