...
- [[.execute()_19]] - `method` [EXTRACTED]
- [[.set_context()_2]] - `method` [EXTRACTED]
...
- [[Tool to spawn a subagent for background task execution.          The subagent]] - `rationale_for` [EXTRACTED]
