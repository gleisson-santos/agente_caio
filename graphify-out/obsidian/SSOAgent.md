...
- [[._collect_fallback()]] - `method` [EXTRACTED]
- [[._collect_psutil()]] - `method` [EXTRACTED]
- [[._run_loop()_5]] - `method` [EXTRACTED]
- [[.get_detailed_metrics()]] - `method` [EXTRACTED]
- [[.get_metrics()_6]] - `method` [EXTRACTED]
...
- [[VPS  server monitoring agent.      Collects system metrics every N seconds]] - `rationale_for` [EXTRACTED]
- [[_init_monitoring_agents()]] - `calls` [INFERRED]
- [[sso_agent.py]] - `contains` [EXTRACTED]
