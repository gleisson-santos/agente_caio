...
- [[Ferramenta para criação de documentos profissionais formatados.     Permite que]] - `rationale_for` [EXTRACTED]
...
- [[documentos.py]] - `contains` [EXTRACTED]
