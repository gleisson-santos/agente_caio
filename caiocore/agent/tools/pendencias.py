...
class PendenciasTool(Tool):
    ...
    def __init__(self, workspace: Path):
        ...
        # __file__ = .../Agente_caio/caiocore/agent/tools/pendencias.py
        ...
        self._status_file = _project_root / "caiocore" / "agents" / "extracao_pendencias" / "status.json"
        self._script_path = _project_root / "caiocore" / "agents" / "extracao_pendencias" / "agendador.py"
