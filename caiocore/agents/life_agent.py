...
# Specialists are now dynamically loaded from agents_list.json in the gateway command
...
class LifeAgent(BaseAgent):
    ...
    async def _check_agent(self, agent_id: str) -> None:
        ...
        try:
            ...
            is_specialist = getattr(agent_obj, "tier", 1) == 2

            self._health_matrix[agent_id] = {
                "status": current_status,
                "type": "specialist" if is_specialist else "agent",
